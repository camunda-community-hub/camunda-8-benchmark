...
public class PartitionHashUtilTest {
    ...
    void testGetTargetPartitionsForClient() {
        ...
        for (int partition : client0_100p4s) coveredPartitions[partition - 1] = true;
        for (int partition : client1_100p4s) coveredPartitions[partition - 1] = true;
        for (int partition : client2_100p4s) coveredPartitions[partition - 1] = true;
        for (int partition : client3_100p4s) coveredPartitions[partition - 1] = true;
    ...
    void testHashDistribution() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            partitionsUsed[partition - 1] = true; // partition is 1-based
        }
